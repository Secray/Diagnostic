...
public class ProximityFragment extends TestFragment implements SensorEventListener {
    ...
    protected void initViewEvents(View view) {
        mNearFirst = (CheckBox) view.findViewById(R.id.box_txt_1);
        mFast = (CheckBox) view.findViewById(R.id.box_txt_2);
        mNearSecond = (CheckBox) view.findViewById(R.id.box_txt_3);
        mNearFirstTxt = (TextView) view.findViewById(R.id.txt_box_1);
        mFastTxt = (TextView) view.findViewById(R.id.txt_box_2);
        mNearSecondTxt = (TextView) view.findViewById(R.id.txt_box_3);
    ...
    {
        super.onPause();
        mSensorManager.unregisterListener(ProximityFragment.this);
    }
    ...
    {
        super.onResume();
        mSensorManager.registerListener(ProximityFragment.this, mSensor, SensorManager.SENSOR_DELAY_UI);
    }
